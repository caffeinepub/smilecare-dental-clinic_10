...
export class Backend implements backendInterface {
    ...
    async addTestimonial(arg0: string, arg1: bigint, arg2: string): Promise<string> {
    ...
    async bookAppointment(arg0: string, arg1: string, arg2: string, arg3: string, arg4: string): Promise<string> {
        if (this.processError) {
            try {
